...
public class Sistema {
	...
	public void crear_pto(int id, float f, float g){
	...
	public void crear_calle(int id_calle, int id_pto_ini, int id_pto_fin){
	...
	public void crear_ambulancia(Class<? extends Ambulancia> cl,int x){
		...
		if (!isEn_simulacion()){
			...
			i.informar("No se puede crear una ambulancia mientras el sistema este activo");
		}
	...
	public void continuar(){
		if(isEn_simulacion()){
			i.informar("TimeStamp = " + this.tiempo);

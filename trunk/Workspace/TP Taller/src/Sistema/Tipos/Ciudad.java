...
public class Ciudad{
	...
	/** Carga una Ciudad desde la Base de Datos a partir de un Id
	 * @param idCiudad
	 * @throws AccesoBaseDatosException
	 * @return */
	public boolean cargarCiudadBD (String idCiudad) throws AccesoBaseDatosException {
		return Utils.Admin_Ciudad.Cargar_Ciudad_BD(this.esquinas,this.calles,idCiudad);		
	}
	
	/** Graba una Ciudad hacia la Base de Datos a partir de un ID
	 * @param idCiudad
	 * @throws AccesoBaseDatosException */
	public boolean grabarCiudadBD(String idCiudad) throws AccesoBaseDatosException  {
		return Utils.Admin_Ciudad.Grabar_Ciudad_BD(this.esquinas,this.calles,idCiudad);
	}
